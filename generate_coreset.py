...
if __name__ == "__main__":
    ...
    os.makedirs('data/AffinityMat_base/{}/'.format(downstream_data_name), exist_ok=True)
    ...
    plt.tight_layout()
    plt.savefig('data/AffinityMat_base/{}/downstream_{}_codelength_{}_hash_bloomsamples_{}.pdf'.format(downstream_data_name, downstream_data_name, code_length, openset_name), bbox_inches='tight', dpi=300)
    plt.clf()
    plt.close('all')
    #####
    ...
    plt.yticks(fontsize=18)
    plt.tight_layout()
    plt.savefig('data/AffinityMat_base/{}/downstream_{}_codelength_{}_hash_bloomfilter_{}.pdf'.format(downstream_data_name, downstream_data_name, code_length, openset_name), bbox_inches='tight', dpi=300)
    plt.clf()
    plt.close('all')
    #####
