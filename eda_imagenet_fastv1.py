...
if __name__ == '__main__':
    ...
    plt.tight_layout()
    # plt.show()
    plt.savefig('save/plots/{}/all_plot_imagenet_{}_kmeans.pdf'.format(downstream, downstream), bbox_inches='tight', dpi=300)
    plt.close()
    ...
    # plt.show()
    plt.savefig('save/plots/{}/topk_plot_imagenet_{}_kmeans.pdf'.format(downstream, downstream), bbox_inches='tight', dpi=300)
    plt.close()
    ...
    plt.savefig('save/plots/{}/topk_images_imagenet_{}_kmeans.pdf'.format(downstream, downstream), bbox_inches='tight', dpi=300)
    plt.close()
    ...
    # plt.show()
    plt.subplots_adjust(wspace=0.05, hspace=-0.5)
    plt.savefig('save/plots/{}/bottomk_images_imagenet_{}_kmeans.pdf'.format(downstream, downstream), bbox_inches='tight', dpi=300)
    plt.close()