...
base_folder = '../../dataset/Stanford40/JPEGImages/'

train_path = '../../dataset/Stanford40/ImageSplits/train.txt'
test_path = '../../dataset/Stanford40/ImageSplits/test.txt'

# Here declare where you want to place the train/test folders
# You don't need to create them!
test_folder = '../../dataset/stanford40/test/'
train_folder = '../../dataset/stanford40/train/'
