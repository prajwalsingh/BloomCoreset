...
base_folder = '../../dataset/indoorCVPR_09/Images/'

train_path = '../../dataset/indoorCVPR_09/TrainImages.txt'
test_path = '../../dataset/indoorCVPR_09/TestImages.txt'

# Here declare where you want to place the train/test folders
# You don't need to create them!
test_folder = '../../dataset/mit67/test/'
train_folder = '../../dataset/mit67/train/'
