...
metadata = scipy.io.loadmat("../../dataset/dtd-r1.0.1/dtd/imdb/imdb.mat")
meta = metadata['images'][0,0]
ROOT = '../../dataset/dtd-r1.0.1/dtd/images'

traindir = '../../dataset/dtd/train'
testdir = '../../dataset/dtd/test'
...
vallist = list()
testlist = list()
with open('../../dataset/dtd-r1.0.1/dtd/labels/train1.txt') as f:
    for file in f.readlines():
        trainlist.append(file.strip())
with open('../../dataset/dtd-r1.0.1/dtd/labels/val1.txt') as f:
    for file in f.readlines():
        vallist.append(file.strip())
with open('../../dataset/dtd-r1.0.1/dtd/labels/test1.txt') as f:
    for file in f.readlines():
