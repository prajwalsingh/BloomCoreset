...
if __name__ == "__main__":
    ...
    simscore_temp, _ = torch.max(simscore, dim=0)
    print(simscore_temp, simscore_temp.max(), simscore_temp.min())
    simscore_idx  = torch.argsort(simscore_temp, dim=-1, descending=True).cpu().numpy()[:filter_openset_size]
    print(simscore_idx)
